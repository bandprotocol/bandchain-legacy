...
//   auto height_raw = ctx.store.get_protected_key("Band Protocol Block
//   Height"); if (height_raw) {
...
//   Address stake_id =
//   Address::hex("1313131313131313131313131313131313131313"); Stake& stake =
//   ctx.create<Stake>(stake_id, band); Address wiki_id =
//   Address::hex("eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");
...
//   Address stake_id =
//   Address::hex("1313131313131313131313131313131313131313");
//   ctx.store.switch_to_tx();
