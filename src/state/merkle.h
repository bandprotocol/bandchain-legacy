...
public:
  ...
  /// Return a new tree with the given object added. Throw if the given object's
...
private:
  /// Find the object corresponding to the given key. Return nullptr on failure.
  const Object* find_object(const Hash& key) const;
