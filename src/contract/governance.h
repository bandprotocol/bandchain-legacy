...
//     return "losing_threshold: {}, winning_threshold: {}, min_deposit: {},
//     commit_duration: {}, reveal_duration: {}"_format(
//         _losing_threshold, _winning_threshold, _min_deposit,
...
//     return "losing_threshold: {}, winning_threshold: {}, min_deposit: {},
//     commit_duration: {}, reveal_duration: {}"_format(
//         +losing_threshold, +winning_threshold, +min_deposit,
