...
//   // Query
//   std::vector<std::pair<Address, uint256_t>> topx(uint16_t value) const;

//   // Add reward from block that dest proposed block. (Store for claiming
//   reward) void add_reward(const Address& party_leader, uint256_t value);
