...
//   void commit_vote(uint256_t poll_id, Hash secret_hash, uint256_t
//   num_tokens);
...
//   Hash get_commit_hash(const Address& address, const uint256_t& poll_id)
//   const;
...
// private:
//   Mapping<Address, Data<uint256_t>> voting_power{sha256(m_addr,
//   uint16_t(3))};
