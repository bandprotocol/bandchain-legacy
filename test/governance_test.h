...
//     Address gvn_id = Address::rand();
//     {
//       ctx.create<Governance>(gvn_id, band, voting_id, 30, 70, 1000, 100,
//       100);
//     }
...
//       account->set_sender();
//       Buffer buf;
//       add_buffer(buf, uint16_t(60), uint16_t(50), uint16_t(150),
//       uint16_t(100),
...
//       band = Address::hex("bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb");
//       Curve linear = Curve(std::make_unique<EqVar>());
//       ctx.create<Token>(band, band, linear);
...
//       account->set_sender();
//       Buffer buf;
//       add_buffer(buf, uint16_t(50), uint16_t(50), uint16_t(150),
//       uint16_t(100),
