...
public:
  void testPushToBuffer(void)
  {
    Buffer write_buf;
    MintMsg mint;
    mint.value = BigInt::from_hex("da73e9ed53fc63c3d8fca9b027119681dc26439e85613bfb0b4870304642c487");
    mint.addr = Address::from_hex("2de9bf7fc075cc48a3f799f5138ca1708f4d0e2a");
    mint.ident = Hash::from_hex("4cc65c5b6d75d81d0a58ca56b3cb73bc95c59fb19bcc06c6950143d9bd050583");
  ...
  void testReadFromBuffer(void)
  {
    ...
    Hash ident = Hash::from_hex("4cc65c5b6d75d81d0a58ca56b3cb73bc95c59fb19bcc06c6950143d9bd050583");
