...
public:
  ...
  void testInit()
  {
    ...
    TS_ASSERT_EQUALS(
        ContractID::from_string("CX09 CCCC CCCC CCCC CCCC CCCC CCCC CCCC CCCC"),
        band_contract.base_contract_id);
    TS_ASSERT_EQUALS(
        AccountID::from_string("AX72 AAAA AAAA AAAA AAAA AAAA AAAA AAAA AAAA"),
        band_contract.beneficiary);
    TS_ASSERT_EQUALS(
        RevenueID::from_string("RX70 RRRR RRRR RRRR RRRR RRRR RRRR RRRR RRRR"),
        band_contract.revenue_id);
...
private:
  ContractID create_community_contract(Handler& hand, const AccountID& MrA)
  {
    ...
    ContractID contract_id = ContractID::from_addr(ed25519_vk_to_addr(tx_hash));
                                     ...
                                     const RevenueID& revenue_id)
  {
    ...
    Hash tx_hash = Hash::rand();
    ContractID product_id = ContractID::from_addr(ed25519_vk_to_addr(tx_hash));
    hand.apply_create_contract(MrA, cc_msg, tx_hash, 0);
    return product_id;
  }
